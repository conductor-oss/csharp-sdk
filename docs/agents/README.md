...
| [advanced.md](advanced.md) | Runtime options, the `IAgentClient` control plane, deploy/serve/run/plan, worker tuning, structured output, credentials, plans / PLAN_EXECUTE. |
...
You need a running Conductor/Agentspan server (default `http://localhost:8080/api`). See [getting-started.md](getting-started.md).
</content>
